...
### Before the evaluation, there are the definitions.
Refresh your definitions of the 10 heuristics and use them to inform your designs in 10 Usability Heuristics.

### What You'll Learn
- How to choose and train your evaluation team
- When to conduct a heuristic evaluation
- Step-by-step process for conducting evaluations
- How to document and consolidate findings
- When to make exceptions to heuristics
...
Heuristic evaluations are useful for stretching a limited UX research budget, because they help you find likely issues without having to test with participants. However, heuristic evaluations cannot replace user research. User-experience design is highly contextual. To design good experiences, you’ll still need to test with actual users. But heuristic evaluations can complement your team’s research work; for example, conducting a heuristic evaluation in preparation for an upcoming usability test might help you identify the elements of the design that you should target during testing.
...
The interactive heuristic-evaluation workbook includes a reminder of each of the 10 heuristics, with space for the evaluator to write down issues and recommendations. (Designed by Kelley Gordon and Kate Moran.)
...
- [Why You Only Need to Test with 5 Users](./why-test-5-users.md)
- [Empathy Mapping](./empathy-mapping.md)
- [Design Thinking 101](./design-thinking.md)
- [Jakob's Law](../laws-of-ux/jakobs-law.md)

[Source: Nielsen Norman Group](https://www.nngroup.com/articles/how-to-conduct-a-heuristic-evaluation/)